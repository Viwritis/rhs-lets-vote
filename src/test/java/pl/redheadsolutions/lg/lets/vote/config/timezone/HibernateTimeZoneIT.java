package pl.redheadsolutions.lg.lets.vote.config.timezone;
...
import pl.redheadsolutions.lg.lets.vote.LetsVoteApp;
import pl.redheadsolutions.lg.lets.vote.config.SecurityBeanOverrideConfiguration;
import pl.redheadsolutions.lg.lets.vote.repository.timezone.DateTimeWrapper;
import pl.redheadsolutions.lg.lets.vote.repository.timezone.DateTimeWrapperRepository;

/**
 * Integration tests for the ZoneId Hibernate configuration.
 */
@SpringBootTest(classes = { SecurityBeanOverrideConfiguration.class, LetsVoteApp.class })
