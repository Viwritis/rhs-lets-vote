...
@RestController
@RequestMapping("/api/lets-vote-kafka")
public class LetsVoteKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LetsVoteKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LetsVoteKafkaResource(KafkaProperties kafkaProperties) {
